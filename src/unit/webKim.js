...
function convertImageMsgToHtml(content) {
  ...
  return (
    "<img class='smallImage' width='80' src='" +
    newUrl +
    "' style='CURSOR: hand' bigImgUrl='" +
    newUrl +
    "' alt='' />"
  );
}
...
function convertVideoMsgToHtml(content) {
  ...
  return (
    "<video class='smallImage' width='100' controls muted loop autoplay src='" +
    content +
    "' style='CURSOR: hand'></video>"
  );
}
//解析音频消息元素
function convertAudioMsgToHtml(content) {
  ...
  return (
    "<audio class='smallImage' preload src='" +
    content +
    "' style='CURSOR: hand'></audio>"
  );
}
//
// //自定义图片消息点击放大
